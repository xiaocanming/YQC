...
//            canvas.drawColor(0x00000000, PorterDuff.Mode.CLEAR);//Mode.CLEAR这个比较重要，防止绘制有影子，可以去掉看下效果
...
//            canvas.drawCircle(SmallRockerCircleX1, SmallRockerCircleY1, SmallRockerCircleR1, paint);
            ...
            canvas = sfh.lockCanvas();
            //绘制大圈边框色
            canvas.drawColor(Color.TRANSPARENT, PorterDuff.Mode.CLEAR);//Mode.CLEAR这个比较重要，防止绘制有影子，可以去掉看下效果
            paint.setColor(getResources().getColor(R.color.app_color_blue_3));
            //绘制大圈内填充色
            canvas.drawCircle(RockerCircleX1, RockerCircleY1, RockerCircleR1+20, paint);
            paint.setColor(getResources().getColor(R.color.app_color_description));
            //绘制遥感小圈全色
            canvas.drawCircle(RockerCircleX1, RockerCircleY1, RockerCircleR1, paint);
